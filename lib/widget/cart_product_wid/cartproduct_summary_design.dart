...
class CartProductSummaryDesign extends StatefulWidget {
  ...
  @override
  State<CartProductSummaryDesign> createState() =>
      _CartProductSummaryDesignState();
}

class _CartProductSummaryDesignState extends State<CartProductSummaryDesign> {
  List<int> productId = [];
  @override
  void initState() {
    super.initState();
