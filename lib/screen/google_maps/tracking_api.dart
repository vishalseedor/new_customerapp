...
import '../../models/address/direction_details.dart';
...
class RequestAssistents {
  ...
  static Future<DirectionDetails> obtainPlaceDirectionDetails(
    ...
    directionDetailes.encodepoints =
        res['routes'][0]['overview_polyline']['points'];
    directionDetailes.distanceText =
        res['routes'][0]['legs'][0]['distance']['text'];
    directionDetailes.distanceValue =
        res['routes'][0]['legs'][0]['distance']['value'];

    directionDetailes.durationText =
        res['routes'][0]['legs'][0]['duration']['text'];
    directionDetailes.durationValue =
